@echo off
REM =====================================================
REM Bus Management System - Database Recovery Script v3
REM Purpose: Recover crashed InnoDB tables from .frm and .ibd files
REM Copies both .frm and .ibd files to recovery database
REM =====================================================

echo ========================================
echo Bus Management System Database Recovery v3
echo ========================================
echo.
...
echo ========================================
"%MYSQL_BIN%\mysql.exe" -u %MYSQL_USER% -e "CREATE DATABASE IF NOT EXISTS %RECOVERY_DB%;"
if %ERRORLEVEL% NEQ 0 (
...
echo Step 3: Discarding tablespaces...
echo ========================================
...
echo Step 4: Importing tablespaces...
echo ========================================
