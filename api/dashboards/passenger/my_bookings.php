<?php
/**
 * Passenger My Bookings API
 * Handles booking management for passengers
 */
...
try {
    $sql = "SELECT b.*, t.departure_date, t.departure_time, t.arrival_time, t.status as trip_status,
