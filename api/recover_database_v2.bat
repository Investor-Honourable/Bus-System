@echo off
REM =====================================================
REM Bus Management System - Database Recovery Script v2
REM Purpose: Recover crashed InnoDB tables from .ibd files
REM Handles missing .cfg files by dropping secondary indexes
REM =====================================================

echo ========================================
echo Bus Management System Database Recovery v2
echo ========================================
echo.
...
echo Step 1: Creating recovery database and tables (without secondary indexes)...
echo ========================================
"%MYSQL_BIN%\mysql.exe" -u %MYSQL_USER% < "%SCRIPT_DIR%database_recovery_v2.sql"
if %ERRORLEVEL% NEQ 0 (
