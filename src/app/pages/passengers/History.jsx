...
export function History() {
      ...
      if (data.status === "success" && data.bookings) {
        ...
        const pastTrips = data.bookings
          ...
          .map((b) => ({
            ...
            busNumber: b.bus_number || b.bus_name || "N/A",
            ...
            rawPrice: b.total_price || 0,
            status: b.booking_status,
            rating: null,
          }));
        setRawTrips(pastTrips);
  ...
  const filteredHistory = tripHistory.filter(
    (trip) => {
      const matchesSearch = 
        ...
        String(trip.ticketId).toLowerCase().includes(searchQuery.toLowerCase());
  ...
  const totalSpent = tripHistory
    ...
    .reduce((sum, t) => sum + (t.rawPrice || 0), 0);
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{totalSpent.toLocaleString()} XAF</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1 flex items-center gap-1">
                  {completedTrips > 0 ? "5.0" : "-"}
                  {completedTrips > 0 && <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />}
                </p>
              </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <p className="text-2xl font-bold text-gray-900">{trip.price} XAF</p>
                  {trip.rating && (
              ...
              <div className="grid grid-cols-5 gap-4 py-4 border-t border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{trip.busNumber || 'N/A'}</p>
                </div>
                <div>
