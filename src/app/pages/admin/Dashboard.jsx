...
export function AdminDashboard() {
  ...
  const statCards = [
    ...
    { title: "Total Buses", value: stats.buses, icon: Bus, color: "bg-green-500" },
    { title: "Total Routes", value: stats.routes, icon: Route, color: "bg-purple-500" },
    { title: "Active Trips", value: stats.schedules, icon: Calendar, color: "bg-orange-500" },
    { title: "Total Bookings", value: stats.bookings, icon: Ticket, color: "bg-red-500" },
    { title: "Total Revenue", value: `${stats.totalRevenue.toLocaleString()} XAF`, icon: DollarSign, color: "bg-yellow-500" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Welcome back! Here's an overview of your bus system.</p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm font-medium text-green-700">Add Bus</p>
            </button>
            <button 
            ...
            >
              ...
              <p className="text-sm font-medium text-purple-700">Add Route</p>
            </button>
            <button 
            ...
            >
              ...
              <p className="text-sm font-medium text-orange-700">Schedule Trip</p>
            </button>
          </div>
        </CardContent>
      </Card>
